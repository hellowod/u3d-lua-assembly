...
if [ -f $SRCDIR/src/libluajit.so ]; then
    ...
    cp $SRCDIR/src/libluajit.so ../plugin_luajit/Plugins/Android/libs/armeabi-v7a/libslua.so
fi;
...
if [ -f $SRCDIR/src/libluajit.so ]; then
    ...
    cp $SRCDIR/src/libluajit.so ../plugin_luajit/Plugins/Android/libs/x86/libslua.so
fi;
